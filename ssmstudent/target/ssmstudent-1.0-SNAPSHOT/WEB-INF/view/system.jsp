...
<head>
	...
	<link rel="icon" href="${pageContext.request.contextPath}/login/favicon.ico">
...
<!-- 					</li> -->
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="${pageContext.request.contextPath}/images/my.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">user</cite></a>
...
<!-- 							<dd><a href="javascript:;" data-url="page/user/userInfo.html"><i class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd> -->
							<dd><a href="javascript:;" data-url="${pageContext.request.contextPath}/SystemServlet/toChangePwd"><i class="seraph icon-xiugai" data-icon="icon-xiugai"></i><cite>修改密码</cite></a></dd>
<!-- 						<dd><a href="javascript:;" class="showNotice"><i class="layui-icon">&#xe645;</i><cite>系统公告</cite><span class="layui-badge-dot"></span></a></dd> -->
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="${pageContext.request.contextPath}/images/my.jpg" class="userAvatar"></a>
			...
			<div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this">
						<a href="javascript:;" data-url="${pageContext.request.contextPath}/page/main.html"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
					</li>
				</ul>
			</div>
		</div>
	...
	layui.use(['bodyTab','form','element','layer','jquery'],function(){
		var form = layui.form,
			...
			menu_json="${pageContext.request.contextPath}/json/navs.json";
			</c:if>
			<c:if test="${userType == 3}">
			menu_json="${pageContext.request.contextPath}/json/teacherMenu.json";
			</c:if>


			<c:if test="${userType == 2}">
			menu_json="${pageContext.request.contextPath}/json/studentMenu.json";
			</c:if>
			tab = layui.bodyTab({
