	...
	            }else {
	    ...
	    function editNews(edit){
	        var index = layui.layer.open({
	            title : "编辑老师",
	            type : 2,
	            content : "${pageContext.request.contextPath}/SystemServlet/toCourseEdit",
	            success : function(layero, index){
	                ...
	                if(edit){
	                   ...
	                   // body.find("#sex").val(edit.sex);
                        ...
                        body.find(".clazzId").val(edit.teacher_id);
	                    form.render();
	                }
	                setTimeout(function(){
	    ...
	    function addNews(edit){
	        var index = layui.layer.open({
	            title : "添加课程",
	            type : 2,
	            content : "${pageContext.request.contextPath}/SystemServlet/toCourseAdd",
	            success : function(layero, index){
	                var body = layui.layer.getChildFrame('body', index);
	                if(edit){
	        ...
	        if(data.length > 0) {
	            ...
	            layer.confirm('确定删除选中的课程？', {icon: 3, title: '提示信息'}, function (index) {
	               ...
	               /*  tableIns.reload();
	                ...
	                $.ajax({
						type: "post",
						url: "${pageContext.request.contextPath}/CourseServlet/DeleteCourse",
						data: {ids:ids},
