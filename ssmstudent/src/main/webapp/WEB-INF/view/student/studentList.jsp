...
<script type="text/javascript" src="${pageContext.request.contextPath}/layui/layui.js"></script>
 ...
 layui.use(['form','layer','laydate','table','laytpl'],function(){
       ...
       $.ajax({
			type: "get",
			url: "${pageContext.request.contextPath}/ClazzServlet/getClazzList?t="+new Date().getTime()+"&from=ok",
			dataType:"json",
	...
	            }else {
	    ...
	    var tableIns = table.render({
	        elem: '#studentList',
	        method: "post",
	        url : '${pageContext.request.contextPath}/StudentServlet/StudentList?t='+new Date().getTime(),
	        cellMinWidth : 95,
	        page : true,
	        height : "full-125",
	        limit : 10,
	        ...
	        cols : [[
	            ...
	            {field:'id',title:'ID',width:50, lign:"center",sortable: true},    
 		        ...
 		        {field:'clazz_id',title:'班级',width:150
 		        	,templet: function(d){
 		        		...
 		        		$.ajax({
 		       			type: "get",
 		       			url: "${pageContext.request.contextPath}/ClazzServlet/getClazzList?t="+new Date().getTime()+"&from=list",
 		       			dataType:"json",
 		       			async : false,//设置为同步
 		       			success:function(data){
 		       	          //  console.log(data);
				...
				{field:'totalgrade',title:'总分',width:150},
	   ...
	   /*  //是否置顶
	    ...
	    function editNews(edit){
	        var index = layui.layer.open({
	            title : "编辑用户",
	            type : 2,
	            content : "${pageContext.request.contextPath}/SystemServlet/toStudentEdit",
	            success : function(layero, index){
	                ...
	                if(edit){
	                   ...
	                   // body.find("#sex").val(edit.sex);
	                    ...
	                    body.find(".edit_age").val(edit.age);
	                    //alert(edit.clazz_id);
	                    body.find(".clazzId").val(edit.clazz_id);
	                    form.render();
	                }
	                setTimeout(function(){
	    ...
	    function addNews(edit){
	        var index = layui.layer.open({
	            title : "添加用户",
	            type : 2,
	            content : "${pageContext.request.contextPath}/SystemServlet/toStudentAdd",
	            success : function(layero, index){
	                var body = layui.layer.getChildFrame('body', index);
	                if(edit){
	                    body.find(".newsName").val(edit.name);
	        ...
	        if(data.length > 0) {
	            ...
	            layer.confirm('确定删除选中的用户？', {icon: 3, title: '提示信息'}, function (index) {
	               ...
	               /*  tableIns.reload();
	                ...
	                $.ajax({
						type: "post",
						url: "${pageContext.request.contextPath}/StudentServlet/DeleteStudent",
						data: {ids:ids},
