	   ...
	   /*  //是否置顶
	    ...
	    function editNews(edit){
	        var index = layui.layer.open({
	            title : "编辑用户",
	            type : 2,
	            content : "${pageContext.request.contextPath}/SystemServlet/toClazzEdit",
	    ...
	    function addNews(edit){
	        var index = layui.layer.open({
	            title : "添加用户",
	            type : 2,
	            content : "${pageContext.request.contextPath}/SystemServlet/toClazzAdd",
	            success : function(layero, index){
	                var body = layui.layer.getChildFrame('body', index);
	                if(edit){
	                    body.find(".newsName").val(edit.name);
	        ...
	        if(data.length > 0) {
	            ...
	            layer.confirm('确定删除选中的班级？', {icon: 3, title: '提示信息'}, function (index) {
	               ...
	               /*  tableIns.reload();
	                ...
	                $.ajax({
						type: "post",
						url: "${pageContext.request.contextPath}/ClazzServlet/DeleteAllClazz",
						data: {newsId:newsId},
	        ...
	        if(layEvent === 'edit'){ //编辑
	            ...
	            layer.confirm('确定删除此班级？',{icon:3, title:'提示信息'},function(index){
	                ...
	                // })
	                    ...
	                    $.ajax({
							type: "post",
							url: "${pageContext.request.contextPath}/ClazzServlet/DeleteClazz",
