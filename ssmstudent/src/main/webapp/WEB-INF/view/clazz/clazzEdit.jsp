			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" id="edit_ID" readonly="readonly" name="id" class="layui-input newsID" lay-verify="newsID" placeholder="请输入用户ID">
					</div>
				</div>
				<div class="layui-form-item magt3">
 ...
 */	        //弹出loading
	        ...
	        // })
	        	$.ajax({
					type: "post",
					url: "${pageContext.request.contextPath}/ClazzServlet/EditClazz",
